    ...
    return (
        <SafeAreaView style={{
            ...
            <WebView
                ...
                source={{ uri: `${Constants.BASE_URL}user-paystripe/${base64.encode(route?.params?.UserID)}/${base64.encode(route?.params?.Amount)}/${base64.encode(route?.params?.PlanDuration)}/full` }}
